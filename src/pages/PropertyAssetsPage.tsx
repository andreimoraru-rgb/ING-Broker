...
export const PropertyAssetsPage: React.FC<PropertyAssetsPageProps> = ({ lang }) => {
  const t = translations[lang].propertyAssets;
  const seo = translations[lang].seo.propertyAssets;
          ...
          <div className="grid lg:grid-cols-12 gap-20 items-start">
            ...
            <div className="lg:col-span-7 pt-4">
              <h2 className="text-2xl font-bold text-secondary mb-6">
                {lang === 'ro' ? 'Asigurare imobile și utilaje pentru afacerea ta' : lang === 'ru' ? 'Страхование недвижимости и оборудования для вашего бизнеса' : 'Real Estate and Equipment Insurance for Your Business'}
              </h2>
            ...
            {t.industries.items.map((item, i) => (
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  <img 
                    src={item.image || industryImages[i]} 
                    alt={item.title} 
      ...
      <section className="py-32 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-left max-w-3xl mb-20">
            ...
            <p className="text-gray-500 font-light text-lg">{lang === 'ro' ? 'O evaluare strategică a factorilor critici în asigurarea bunurilor și proprietăților.' : lang === 'ru' ? 'Стратегическая оценка критических факторов при страховании имущества и активов.' : 'A strategic assessment of critical factors in property and assets insurance.'}</p>
          </div>
