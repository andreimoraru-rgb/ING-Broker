...
id: '2',
          ...
          <a href="tel:+37369526003" class="flex-shrink-0 bg-primary text-white font-bold px-6 py-3 rounded-lg text-sm text-center whitespace-nowrap">Sună: +373 695 26 003</a>
          </div>
          </div>
          ...
          <a href="tel:+37369526003" class="inline-flex items-center justify-center gap-2 bg-primary text-white font-bold px-8 py-4 rounded-lg text-base">+373 695 26 003</a>
...
<div class="not-prose my-8 bg-secondary text-white rounded-xl p-6">
  <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
    ...
    <a href="tel:+37369526003" class="flex-shrink-0 bg-primary text-white font-bold px-6 py-3 rounded-lg text-sm text-center whitespace-nowrap">Suna: +373 695 26 003</a>
  </div>
</div>
  ...
  <div class="flex flex-wrap justify-center gap-6 text-xs text-gray-500">
    ...
    <span>Consultanta gratuita</span>
      ...
      seo: {
        ...
        description: 'Asigurari CMR, Cargo, CASCO flota si depozite pentru transportatori din Moldova. Oferta personalizata in 24h. Autorizat CNPF. Suna: +373 695 26 003 - ING Broker.',
...
<div class="bg-secondary text-white p-8 rounded-xl text-center mt-10 not-prose">
  ...
  <div class="flex flex-wrap justify-center gap-6 text-xs text-gray-500">
    ...
    },
    {
      ...
      title: 'Asigurare flote auto corporate în Moldova: RCA, Carte Verde, CASCO, CMR, Cargo',
      excerpt: 'Gestionezi o flotă de vehicule? ING Broker oferă soluții complete pentru asigurarea flotelor auto corporate în Moldova - RCA, Carte Verde, CASCO, CMR și Cargo - dintr-o singură sursă, cu ofertă personalizată și suport dedicat.',
      ...
      seo: {
        ...
        description: 'ING Broker oferă soluții pentru asigurarea flotelor auto corporate în Moldova: RCA, Carte Verde, CASCO, CMR, Cargo. Ofertă personalizată, un singur contract, manager dedicat.',
        keywords: ['asigurare flote auto Moldova', 'RCA flotă corporate', 'Carte Verde flotă', 'CASCO flotă Moldova', 'asigurare CMR Moldova', 'asigurare Cargo Moldova', 'asigurare camioane Moldova', 'ING Broker flote']
      },
      content: `<div class="prose prose-lg max-w-none"><h2>De ce asigurarea flotei e diferită față de o poliță individuală</h2><p>O flotă de 5, 20 sau 100 de vehicule nu e pur și simplu mai multe mașini. E un risc concentrat, un buget anual predictibil și un parteneriat care trebuie să funcționeze exact atunci când contează.</p><p>Companiile care gestionează flote auto în Moldova se confruntă cu aceeași problemă: polițe individuale emise la întâmplare de diverși asigurători, date de expirare diferite, franșize diferite, proceduri diferite de daune. Haos administrativ care costă timp și bani.</p><p><strong>ING Broker consolidează asigurarea întregii flote</strong> - un singur interlocutor, un singur contract-cadru, termeni uniformi, reînnoire sincronizată.</p><h2>Tipuri de asigurări pentru flote auto corporate în Moldova</h2><h3>1. RCA - Asigurarea obligatorie de răspundere civilă auto</h3><p>RCA este obligatorie prin lege pentru toate vehiculele înmatriculate în Republica Moldova. Calculează prețul RCA pentru vehiculele flotei: <a href="https://easigurari.com/ro/rca" target="_blank" rel="noopener">calculator RCA easigurari.com</a></p><ul><li>Tarif negociat per vehicul, în funcție de volumul flotei</li><li>Date de expirare sincronizate pentru toată flota</li><li>Administrare centralizată - un singur document de referință</li><li>Suport prioritar la daune pentru partenerii corporate</li></ul><h3>2. Carte Verde - Asigurarea internațională pentru flotele cu deplasări externe</h3><p>Dacă vehiculele flotei traversează granița - fie că e vorba de șoferi de livrare, agenți comerciali sau manageri - Cartea Verde este obligatorie în peste 48 de țări membre ale sistemului internațional, inclusiv toate statele UE, România, Ucraina, Georgia, Turcia.</p><p>Calculează prețul exact pentru fiecare vehicul: <a href="https://easigurari.com/ro/green-card" target="_blank" rel="noopener">calculator Carte Verde easigurari.com</a></p><h3>3. CASCO - Protecția vehiculelor flotei</h3><p>CASCO este asigurarea facultativă care protejează vehiculele flotei tale - nu terții, ci mașinile propriu-zise. Acoperă: accidente rutiere (inclusiv din vina propriului șofer), furt, calamități naturale (grindină, inundații), vandalism, incendiu și daune în parcări.</p><p>Pentru flote, CASCO se poate structura cu <strong>franșiză colectivă</strong>, o soluție care reduce prima totală față de polițele individuale.</p><h3>4. CMR - Asigurarea răspunderii transportatorului de marfă internațional</h3><p>Dacă flota ta transportă marfă pentru terți în trafic internațional, CMR este obligatorie prin convenție internațională. Acoperă răspunderea legală a transportatorului pentru pierderea sau deteriorarea mărfii și pentru întârzieri. Răspunderea se calculează după regula stabilită de Convenția CMR, nu după valoarea comercială a mărfii - de aceea o singură daună poate depăși semnificativ ce recuperează transportatorul.</p><h3>5. Cargo - Asigurarea mărfii transportate</h3><p>CMR protejează transportatorul. Cargo protejează marfa. Pentru companiile care transportă propriile produse, Cargo acoperă daune fizice, furt, pierdere totală și daune la încărcare sau descărcare. Se emite per călătorie sau anual, ca open policy.</p><h3>6. Asigurarea răspunderii față de călători</h3><p>Pentru flotele care transportă persoane, această asigurare acoperă prejudiciile corporale produse pasagerilor în accidente - complement necesar la RCA.</p><h2>Cum se stabilește prețul unui program de flotă</h2><p>Nu există un tarif unic de flotă. Prima finală se construiește pe baza mai multor factori, iar fiecare asigurător îi ponderează diferit:</p><ul><li><strong>Structura flotei</strong> - categoriile de vehicule, masa maximă autorizată, vechimea parcului</li><li><strong>Utilizarea</strong> - transport de marfă, transport de persoane, deplasări urbane sau internaționale</li><li><strong>Rutele</strong> - trafic intern, UE, spațiul CSI, zone cu risc ridicat</li><li><strong>Istoricul de daune</strong> - cel mai puternic factor pentru flotele mature</li><li><strong>Volumul</strong> - numărul de vehicule și primele cumulate din contract</li><li><strong>Structura franșizei</strong> - franșiză individuală sau colectivă pe flotă</li></ul><p>Pentru că fiecare asigurător evaluează aceleași riscuri după algoritmi proprii, diferența dintre prima cea mai mică și cea mai mare pentru aceeași flotă poate fi semnificativă. Aici intervine brokerul: comparăm simultan ofertele asigurătorilor autorizați CNPF și îți prezentăm varianta optimă pentru fiecare tip de vehicul, nu un singur tarif impus.</p><p>Pentru un calcul orientativ imediat pe vehicul, folosește calculatoarele publice:</p><div style="display:flex;gap:1rem;flex-wrap:wrap;margin:1.5rem 0;"><a href="https://easigurari.com/ro/green-card" target="_blank" rel="noopener" style="display:inline-block;padding:0.75rem 1.5rem;background:#E31E24;color:#fff;font-weight:600;text-decoration:none;">Calculează Carte Verde online</a><a href="https://easigurari.com/ro/rca" target="_blank" rel="noopener" style="display:inline-block;padding:0.75rem 1.5rem;border:1px solid #141414;color:#141414;font-weight:600;text-decoration:none;">Calculează RCA online</a></div><h2>Avantajele unui contract de flotă</h2><table><thead><tr><th>Criteriu</th><th>Polițe individuale</th><th>Contract de flotă ING Broker</th></tr></thead><tbody><tr><td>Tarif per vehicul</td><td>Standard, tarif retail</td><td>Negociat pe volumul flotei</td></tr><tr><td>Administrare</td><td>Fiecare vehicul separat</td><td>Un singur contract-cadru</td></tr><tr><td>Expirare polițe</td><td>Date diferite, risc de omisiuni</td><td>Sincronizat, notificări automate</td></tr><tr><td>Adăugare vehicule noi</td><td>Proces separat, întârzieri</td><td>Act adițional la contract, emitere rapidă</td></tr><tr><td>Suport la daune</td><td>Standard</td><td>Manager dedicat, prioritate</td></tr><tr><td>Raportare</td><td>Nu există</td><td>Raport daune și costuri anuale</td></tr></tbody></table><h2>Sectoare care beneficiază cel mai mult</h2><ul><li><strong>Logistică și transport marfă</strong> - camioane, furgonete, autotrenuri. Combinație recomandată: RCA + Carte Verde + CMR + Cargo.</li><li><strong>Construcții și utilaje</strong> - vehicule de teren, utilaje grele, mașini de șantier.</li><li><strong>Distribuție și retail</strong> - furgonete și autoturisme pentru agenți comerciali.</li><li><strong>Agricultură</strong> - tractoare, combine, vehicule agricole.</li><li><strong>Companii IT și servicii</strong> - flote de autoturisme pentru angajați și management.</li><li><strong>Instituții financiare</strong> - vehicule blindate cu clauze speciale pentru transport de valori.</li></ul><h2>Procesul de asigurare a flotei la ING Broker</h2><ol><li><strong>Audit flotă, gratuit</strong> - analizăm lista vehiculelor, rutele și istoricul de daune.</li><li><strong>Ofertă personalizată</strong> - comparăm ofertele asigurătorilor autorizați CNPF.</li><li><strong>Negociere condiții</strong> - franșize, limite, clauze suplimentare, modalitate de plată.</li><li><strong>Emitere polițe</strong> - toate documentele emise electronic.</li><li><strong>Suport continuu</strong> - manager dedicat pentru daune, modificări de flotă, reînnoire anuală.</li></ol><h2>Întrebări frecvente</h2><h3>Câte vehicule minim are o flotă pentru contract special?</h3><p>La ING Broker, oferim condiții de flotă de la 3 vehicule în sus.</p><h3>Pot asigura vehicule din mai multe categorii?</h3><p>Da. Un contract de flotă poate include vehicule din categorii diferite, cu polițe adaptate fiecărei categorii.</p><h3>Ce se întâmplă când adaug un vehicul nou?</h3><p>Vehiculul nou se adaugă prin act adițional la contractul existent, fără renegocierea întregului program.</p><h3>Cât durează să obțin o ofertă pentru flota mea?</h3><p>Analiza flotei și pregătirea ofertei încep imediat ce primim lista vehiculelor. Termenul exact îl confirmăm la preluarea cererii.</p><h3>Ce documente sunt necesare?</h3><p>Lista vehiculelor (număr de înmatriculare, an de fabricație, marcă și model, tip de utilizare), istoricul de daune pe ultimii 2-3 ani și datele companiei.</p><p style="margin-top:2rem;padding:1.25rem;background:#F4F4F5;border-left:4px solid #9CA3AF;font-size:0.95rem;color:#3F3F46;"><em>Materialul are caracter informativ și nu constituie ofertă contractuală. Acoperirile, franșizele și limitele se stabilesc individual, prin contract. Condițiile contractuale primează asupra oricărui material de marketing. Insurance ING Broker SRL este intermediar de asigurare autorizat CNPF.</em></p><p style="margin-top:1.5rem;padding:1.5rem;background:#0B0F1A;color:#fff;border-left:4px solid #E31E24;"><strong>ING Broker - str. Pan Halippa 9, mun. Chișinău, MD-2009</strong><br/>Tel: <a href="tel:+37369526003" style="color:#E31E24;">+373 695 26 003</a><br/>Email: <a href="mailto:andrei.moraru@ingbroker.md" style="color:#E31E24;">andrei.moraru@ingbroker.md</a></p></div>`
    },
    ...topics.map((t, index) => ({
