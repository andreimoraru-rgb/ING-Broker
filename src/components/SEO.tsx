...
interface SEOProps {
      ...
      image?: string;
      /**
       * Cere motoarelor sa nu indexeze pagina, dar sa urmeze linkurile din ea.
       * Folosit pentru articolele generate automat din sablon (vezi campul
       * `autoGenerated` din src/data/articles.ts): sunt ~190 de pagini cu aceeasi
       * structura, iar indexarea lor expune tot domeniul la sanctiunea Google
       * pentru scaled content abuse.
       */
      noIndex?: boolean;
}

export const SEO = ({ title, description, lang, schema, keywords, noIndex = false, image = "https://www.ingbroker.md/Logo%20ING%20Broker.png" }: SEOProps) => {
